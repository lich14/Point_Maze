...
class Maze:
    ...
    def __init__(self, *segment_dicts, goal_squares=None, start_squares=None, min_wall_coord=None, walls_to_add=(), walls_to_remove=()):
...
def make_experiment_maze(h, half_w, sz0):
    ...
    for h_ in range(1, h):
        ...
        for w_ in range(w - 2, -1, -1):
            segments.append({'anchor': '{},{}'.format(h_, w_ + 1), 'direction': 'left', 'connect': c, 'name': '{},{}'.format(h_, w_)})
...
mazes_dict['square_corridor2'] = {'maze': Maze(*segments_corridor, goal_squares=['b4'], start_squares=['a4']), 'action_range': 0.95}
...
mazes_dict['square_bottleneck'] = {
    'maze': Maze(*segments_crazy, goal_squares='9,9', min_wall_coord=4, walls_to_remove=_walls_to_remove, walls_to_add=_walls_to_add),
    'action_range': 0.95
}
