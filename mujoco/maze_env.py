...
class MazeEnv(gym.Env):
    ...
    def __init__(self,
        ...
        self.blocks = any(
            any(maze_env_utils.can_move(r) for r in row) for row in structure)  # Are there any movable blocks?
            ...
            for j in range(len(structure[0])):
                ...
                if self.elevated and struct not in [-1]:
                    ...
                    ET.SubElement(
                        ...
                        pos="%f %f %f" %
                        (j * size_scaling - torso_x, i * size_scaling - torso_y, height / 2 * size_scaling),
                        size="%f %f %f" % (0.5 * size_scaling, 0.5 * size_scaling, height / 2 * size_scaling),
                        type="box",
                        material="",
                        contype="1",
                        conaffinity="1",
                ...
                if struct == 1:  # Unmovable block.
                    ...
                    ET.SubElement(
                        ...
                        pos="%f %f %f" % (j * size_scaling - torso_x, i * size_scaling - torso_y,
                    ...
                    movable_body = ET.SubElement(
                        ...
                        "body",
                        name=name,
                        pos="%f %f %f" % (j * size_scaling - torso_x + x_offset, i * size_scaling - torso_y + y_offset,
                    ...
                    ET.SubElement(movable_body,
                                  ...
                                  name="block_%d_%d" % (i, j),
                                  pos="0 0 0",
                                  size="%f %f %f" % (0.5 * size_scaling * shrink, 0.5 * size_scaling * shrink,
    ...
    def _get_obs(self):
        ...
        return np.concatenate([wrapped_obs, range_sensor_obs[:, 0].flat] + view + [[self.t * 0.001]])
